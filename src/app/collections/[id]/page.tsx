          ...
          <div className="lg:col-span-7 space-y-6 md:space-y-8">
            ...
            >
              ...
              <button 
                ...
                className="absolute bottom-4 right-4 md:bottom-8 md:right-8 bg-white/80 backdrop-blur-md p-3 md:p-4 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-black hover:text-white shadow-lg z-10"
              >
            ...
            <div className="grid grid-cols-4 gap-4">
              {product.images.map((img: string, i: number) => (
                <button 
                  ...
                  className={`relative aspect-square bg-white rounded-xl overflow-hidden border-2 transition-all ${activeImage === i ? 'border-accent' : 'border-transparent hover:border-gray-200'}`}
                >
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 md:gap-0 mb-16">
                ...
                <button 
                  ...
                  className="w-full md:w-auto px-12 h-14 md:h-12 lg:h-14 bg-black text-white text-[10px] uppercase tracking-[0.3em] font-bold hover:bg-accent transition-all duration-500 rounded-sm shadow-xl shadow-black/5"
                >
                  Add to Collection
                </button>
              </div>
